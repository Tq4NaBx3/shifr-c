...
static  inline  void  shifr_streambuf_init  ( t_streambuf * const me  ,
  FILE  * const f ) {
  me -> file  = f ;
  me -> buf = 0 ;
  me -> bufbitsize = 0 ;
...
# ifdef SHIFR_DEBUG    
  ...
  case  2 :
    ...
    number_princ  ( number_size2 ) ( & main_shifrp -> raspr2  . pass . pub , stderr  ) ;
    fputs ( "\n" , stderr ) ;
    break ;
  case  3 :
    fputs ( ( localerus ?
...
# endif
    char  volatile  password_letters2_62  [ password_letters2size ] ;
    char  volatile  password_letters3_62  [ password_letters3size ] ;
    char  volatile  password_letters2_10  [ password_letters2size ] ;
    char  volatile  password_letters3_10  [ password_letters3size ] ;
    char  volatile  password_letters2_26  [ password_letters2size ] ;
    char  volatile  password_letters3_26  [ password_letters3size ] ;
    switch  ( main_shifrp -> use_version ) {
    case  2 :
      password_to_string_templ  ( number_size2 ) ( & main_shifrp -> raspr2  . pass . pub ,
        & main_shifrp -> password_letters2 , & main_shifrp -> letters , letters_count ) ;
      password_to_string_templ  ( number_size2 ) ( & main_shifrp -> raspr2  . pass . pub ,
        & password_letters2_62  , & main_shifrp -> letters2 , letters_count2 ) ;
      password_to_string_templ  ( number_size2 ) ( & main_shifrp -> raspr2  . pass . pub ,
        & password_letters2_10 , & main_shifrp -> letters3 , letters_count3 ) ;
      password_to_string_templ  ( number_size2 ) ( & main_shifrp -> raspr2  . pass . pub ,
...
# ifdef SHIFR_DEBUG        
    ...
    case  2 :
      { number_priv_type ( number_size2 ) password2 ;
        ...
        string_to_password_templ  ( number_size2 ) ( main_shifrp ,
          ( strvcp  ) & main_shifrp -> password_letters2 ,
          & password2 . pub , ( strcp ) & main_shifrp -> letters ,
          letters_count ) ; 
        fputs ( ( localerus ?
        ...
        string_to_password_templ  ( number_size2 ) ( main_shifrp ,
          ( strvcp  ) & password_letters2_62  ,
          & password2 . pub , ( strcp ) & main_shifrp -> letters2 ,
          letters_count2 ) ;
        fputs ( ( localerus ?
        ...
        string_to_password_templ  ( number_size2 ) ( main_shifrp ,
          ( strvcp  ) & password_letters2_26  ,
          & password2 . pub , ( strcp ) & main_shifrp -> letters4 ,
          letters_count4 ) ;
        fputs ( ( localerus ?
        ...
        string_to_password_templ  ( number_size2 ) ( main_shifrp ,
          ...
          & password2 . pub , ( strcp ) & main_shifrp -> letters3 ,
          letters_count3 ) ;
        fputs ( ( localerus ?
    ...
    case  3 :
      { number_priv_type ( number_size3 ) password2 ;
        ...
        string_to_password_templ  ( number_size3 ) ( main_shifrp ,
          ( strvcp  ) & main_shifrp -> password_letters3 ,
          & password2 . pub , ( strcp ) & main_shifrp -> letters ,
          letters_count ) ; 
        fputs ( ( localerus ?
          u8"из строки95 во внутренний пароль = " :
...
# else
  ...
  default :
    ...
    longjmp ( main_shifrp -> jump , 1 ) ; }
# endif
    memsetv ( main_shifrp -> password_letters2  , memsetv_default_char  ,
      sizeof  ( main_shifrp -> password_letters2  ) ) ;
    memsetv ( main_shifrp -> password_letters3  , memsetv_default_char  ,
      sizeof  ( main_shifrp -> password_letters3  ) ) ;
    memsetv ( password_letters2_62  , memsetv_default_char  ,
      sizeof  ( password_letters2_62  ) ) ;
    memsetv ( password_letters3_62  , memsetv_default_char  ,
      sizeof  ( password_letters3_62  ) ) ;
    memsetv ( password_letters2_26  , memsetv_default_char  ,
      sizeof  ( password_letters2_26  ) ) ;
    memsetv ( password_letters3_26  , memsetv_default_char  ,
      sizeof  ( password_letters3_26  ) ) ;
    memsetv ( password_letters2_10  , memsetv_default_char  ,
      sizeof  ( password_letters2_10  ) ) ;
    memsetv ( password_letters3_10  , memsetv_default_char  ,
