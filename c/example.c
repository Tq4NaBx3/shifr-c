...
int main  ( int argc , char * argv [ ] ) {
  ...
  shifr_size_io sizeio  = shifr_encrypt ( v2 ) ( & shif ,
  ...
  shifr_size_io sizeio2  = shifr_encrypt ( v2 ) ( & shif ,
    ( shifr_arrcps ) { .cp = ( shifr_arrcp ) & inbuf ,
      .s = strlen ( (char const*)inbuf ) } ,
  ...
  shifr_size_io sizeiodec  = shifr_decrypt ( v2 ) ( & shif ,
  ...
  shifr_size_io sizeiodec2  = shifr_decrypt ( v2 ) ( & shif ,
  ...
  shifr_size_io sizeiodecf  = shifr_decrypt ( v2 ) ( & shif ,
